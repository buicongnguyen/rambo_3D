...
- Purple minimap dots are weapon pickups. Walk or drive over them, then Q / WEAPON cycles collected weapons. Riding collection uses the vehicle footprint plus a short reach, and solid cover blocks collection. Tanks immediately equip collected weapons and can fire/reload them while mounted. Cannon shells and personal magazines/reserves are independent, persist across swaps/exits, and switching cancels reloading without granting ammunition. Shells cannot be reloaded; firing an empty cannon selects a personal weapon. Collected weapons remain available after dismounting; collection does not refill mounted ammunition. Special weapons have finite reserve ammunition. Exhaustion automatically selects another usable weapon; rifle and shotgun retain the prototype's unlimited reserve.
