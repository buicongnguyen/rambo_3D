...
The late-stage bosses are adapted from Steel Front and scaled to this game's 150 HP commando:

- **SKY WRAITH:** circles you at 13 m and alternates two attacks.
  - A three-ring ROCKET RAIN: 30 damage, 2 s warning.
  - A GUN RUN: seven small rings burst in sequence down a line through your position, 14 damage each. Step sideways to escape.
  - It then hovers low for 2.6 s, exposed.
- **IRON SOVEREIGN:** locks three aim lines for 0.9 s, then fires one 16-damage shell down each. Every third volley it overheats and opens its vents for 2.4 s, exposing its core. If you fall after securing the relay, **RETRY FROM RELAY** restarts at the relay with your health, ammunition, treasure, rescued allies and cleared patrols restored, and the counterattack begins again.
...
Knife rushers chase after alarm; long-sword soldiers telegraph a broad sweep; knife throwers strafe and launch visible spinning blades; rocket troops warn with a locked orange aiming line. Riflemen remain the majority. Roles replace existing patrol slots and appear gradually across the first three missions. The first two stages stay gentle. From stage 3, two more sword soldiers join every block of 20. From stage 5, ninjas replace rushers:

- about 2.7× rifleman speed (5.1 m/s)
- a zig-zag approach that is hard to track
- a 0.42 s katana swing
- only 58 HP, so they go down fast once you hit them Cover, sidestepping and recovery windows give the starter rifle and dodge useful counters. Easy/Normal allow one infantry rocket aiming or airborne at a time; Hard/Crazy allow two.
