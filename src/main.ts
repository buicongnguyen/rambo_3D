...
$("#controls-open").onclick = () => {
  showOverlay(
    `<span class="eyebrow">FIELD MANUAL / 01</span><h2>Get in. Get them out.</h2><p>The first mission is a compact relay raid with 12 soldiers on Normal, two response guards and no requirement to clear every patrol. Start with a rifle and four frag grenades. Q / SWAP selects grenades; mouse aim sets throw distance (3–12.75 meters), while mobile FIRE targets a nearby enemy. The amber ring shows the landing area. Grenades arc over low crates; tall buildings block them. The next mission introduces bikes, jeeps, the shotgun, machine gun and grenade launcher. Full arsenals and tanks arrive at the first finale. Later stages have three progressively longer routes: a zigzag approach, a longer O or U expedition, then the longest S or mirrored S sweep, including rotated 45-degree routes. On O loops, choose either arm around the central woodland; both lead to the relay. Small trees take several hits to destroy and burst into green leaf dust. Buildings still provide solid cover. Approach the yellow relay to secure it automatically and clear its guards; level three has command bosses. Defeat every boss to open green extraction.</p><div class="manual-grid"><span>WASD / ARROWS</span><b>Move</b><span>MOUSE + CLICK</span><b>Aim and fire</b><span>HOLD SPACE</span><b>Assisted aim and fire</b><span>HOLD B / BLAST</span><b>Target explosive stores</b><span>SHIFT + MOVE</span><b>Dodge incoming fire</b><span>E / R / Q</span><b>Interact / reload / switch</b><span>F / TURBO</span><b>Two weapons for 3 seconds</b><span>ESCAPE</span><b>Pause and settings</b></div><p>The Fourfold Titan fires four hand cannons and pauses to reload. Siege Colossus combines twin guns with shoulder rockets. Twin Tempest launches wide salvos from two truck-mounted missile magazines. Leave the orange blast zones before impact. Helicopter, spider and laser-tank bosses also carry a rapid light gun. Orange rings warn of attacks and volcanic rockfalls. Ice slides, sand slows to one quarter, and mud holes gradually sink you. Quake dust signals a brief ground-enemy freeze. Shoot fuel drums and red EXPLOSIVE crates for chain explosions; walls and buildings shield you from the blast. Tanks crush small trees at half speed until their hull clears the debris. Long concrete walls mark the map boundary. Drive a moving tank or jeep over infantry to crush them. Orange rings warn of an attack. Crates stop bullets. Green pickups restore health. The scattergun excels at close range. Blue map dots mark vehicles: the bike, jeep and tank are stationed along the road with defenders. E / USE boards or exits. Nearby interaction hints disappear after one second; the USE / EXIT button and E key remain available. Sniper, rocket and laser caches also have guards. Rock and concrete barriers have been replaced by small destructible trees. Destroy cover to open new firing lanes. Purple dots mark weapons: walk over them to collect, then Q / WEAPON cycles your loadout. Picking up a weapon or exhausting its ammunition automatically chooses the strongest usable weapon; manual switching remains available. Automatic priority favors laser, missile, machine gun, sniper, grenade launcher, explosive bow, flamethrower, frag grenade, rifle, shotgun, then gas grenade. Motorcycles use your selected weapon; jeeps have 20 shotgun rounds. Tanks start with six ready explosive cannon shells. Playable tanks carry 1,680 armor. The M249 fires 30 rounds per second with 10 damage per round, a 120-round belt and a 2.8-second reload. The rifle deals 28 per round. Small arms deal only 20% damage to enemy tank armor; use rockets, explosives or laser. Enemy tank guns deal double damage and their main guns warn for 0.8 seconds. Hold B / BLAST to aim and fire at a visible explosive store; unsafe chains and blocked shots are skipped. Manual mouse aim remains available. BLAST consumes your current weapon ammunition. Look for small groups guarding explosive depots. Every defeated enemy has an independent one-in-three chance to drop one package: health (+15), shield (+20), or a magazine for owned special weapons. Loot expires after 45 seconds; at most 48 enemy packages remain on the battlefield. Roadside medical and shield crates retain their larger recovery. Enemies have a forward vision cone. Crate screens and buildings block sight; break contact and relocate while enemies investigate your last seen position. Gunfire can be heard within 14 meters. Rear bullet hits deal 1.75× damage to infantry and bypass much of a regular tank’s armor. Bosses have no rear-hit bonus. Orange minimap arrows show alerted enemies, muted arrows show searching patrols and their facing. Q / SWAP WEAPON cycles the cannon and your collected weapons, which keep their own magazines and reload reserves. Picking up a weapon automatically selects the strongest usable loadout, including the tank cannon; cannon shells remain stored and cannot be reloaded. Relays secure automatically within three meters, on foot or in a vehicle. Guards emerge from the amber-lit house doorways. Exit the vehicle to extract. F / TURBO activates two different available weapons for 3 seconds; hold FIRE to shoot both. Each consumes its own ammo. Switching is locked until the burst ends, then Turbo cools down for 14 seconds. Tuned Weapons unlocks extra guns on bikes, jeeps and tanks and adds 0.4 seconds per rank, up to 5; vehicle rank 3 permits three guns. Light Kit reduces Turbo cooldown to a minimum of 8 seconds. Touch controls appear on touch devices.</p><button id="close-manual" class="primary">READY FOR THE FIELD <span>↗</span></button>`,
  );
...
function updateHud() {
  ...
  notice.hidden = game.elapsed >= game.combatNoticeUntil;
  notice.textContent = game.combatNotice;
